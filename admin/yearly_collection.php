...
FROM payment_list as p 
    ...
    WHERE p.month_of LIKE CONCAT(:val ,'%')", array(':val' => $year));
                                            ...
                                            <form action="" id="filter-form">
                                                <div class="wrapper">
                                                    <div class="input-wrapper">
                                                            <div><span>Choose Year</span></div>
                                                            <select name="year" value="<?php echo $student_data->course ?>">
                                                                <?php
                        ...
                        <script>
	                        $(document).ready(function(){
		                        $('#filter-form').submit(function(e){
                                    e.preventDefault()
                                    location.href = "/admin/yearly_collection.php?"+$(this).serialize()
                                })
