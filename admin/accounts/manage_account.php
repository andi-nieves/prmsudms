                        ...
                        <div class="card">
	                        <div class="card-header">
		                        ...
		                        <div class="card-tools">
			                        <a href="http://localhost/PRMSUdms/admin/accounts/manage_account.php" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Create New</a>
		                        </div>
	                        </div>
